	...
	<div class="modal-dialog">
		<div class="modal-content corzinha">
			...
			<div class="modal-body">
				...
				<form method="POST"
					action="${pageContext.request.contextPath}/auth/admin?acao=editar"
					...
					<div class="mb-3">
						...
						<div class="input-group col-mb-3">
							<span class="input-group-text" id="basic-addon1"> <i
								class="bi bi-spellcheck"></i>
							</span> <input type="text" name="nome" id="nome" class="form-control">
					...
					<div class="mb-3">
						...
						<div class="input-group col-mb-3">
							...
							</span> <input type="text" name="cpf" id="cpf" class="form-control">
					...
					<div class="mb-3">
						...
						<div class="input-group col-mb-3">
							<span class="input-group-text" id="basic-addon1"> <i
								class="bi bi-person-vcard"></i>
							</span> <input type="text" name="login" id="login" class="form-control">
					...
					<div class="mb-3">
						...
						<div class="input-group col-mb-3">
							<span class="input-group-text" id="basic-addon1"> <i
								...
								class="form-control"> <small id="msgPassword"
					...
					<div class="mb-3">
						...
						<div class="input-group col-mb-3">
							...
							</span> <input type="text" name=nascimento id="nascimento"
								class="form-control"> <small id="msgNasc"
								class="form-text text-danger"></small>
						</div>
					</div>
