				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav">
						...
						<li class="nav-item"><a class="nav-link"
							href="${pageContext.request.contextPath}/login?acao=formLogin">
								Entra </a></li>
					</ul>
				</div>
				...
				<div class="d-flex align-items-center">
					...
					<div class="d-flex" style="margin-right: 15px">
						...
						<div class="dropdown">
							...
							<ul
								class="dropdown-menu dropdown-menu-end bg-success bg-gradient"
								style="width: 350px" aria-labelledby="navbarDropdownMenuAvatar">
								<li class=""
									style="margin-bottom: 15px; margin-left: 10px; margin-right: 10px">
									<div class="alert alert-danger alert-dismissible fade show">
										<button type="button" class="btn-close"
											data-bs-dismiss="alert" aria-label="Close"></button>
										<p>
											<b>Atraso na entrega de:</b>
										</p>
										<hr>
